...
if st.session_state.generated_note_text:
    ...
    components.html(
        ...
        <textarea id="noteText" style="width:100%; height:700px; padding:12px; font-size:14px;">{escaped_text}</textarea>
